...
<body>
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img src="../images/logo.jpg" alt="ảnh logo" style="width:100%;height:200px">
                </div>
            </div>
        </div>
        <div class="container">
            <input type="email" class="form-control" id="floatingInput" placeholder="Tài Khoản">
        ...
        <div class="container">
            <button name="bt" type="submit" class="btn btn-primary">Đăng nhập</button>
        </div>
    </header>
